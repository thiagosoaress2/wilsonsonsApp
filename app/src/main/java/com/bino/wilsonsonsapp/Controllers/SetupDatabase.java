...
public class SetupDatabase{
    ...
    private static final String SQL_CREATE_USER_TABLE = "CREATE TABLE IF NOT EXISTS user (firebase_key text, email text, name text, number text, occupation_id integer, date_nascimento text, photo text)";
